...
API (captured as committed fixtures — see [`docs/DECISIONS.md`](DECISIONS.md) for why), with
...
See [`docs/ARCHITECTURE.md`](ARCHITECTURE.md) for the request-flow diagram and
[`docs/DECISIONS.md`](DECISIONS.md) for the reasoning behind cursor pagination, the
